...
lib.setTypesToName = {
    ...
    [LIBSETS_SETTYPE_BATTLEGROUND                        ] = {
        ...
        ["jp"] = GetString(SI_LEADERBOARDTYPE4) or "戦場",
        ["ru"] = GetString(SI_LEADERBOARDTYPE4) or "полей сражений",
    },
    [LIBSETS_SETTYPE_CRAFTED                        ] = {
        ["de"] = GetString(SI_ITEM_FORMAT_STR_CRAFTED),
        ["en"] = GetString(SI_ITEM_FORMAT_STR_CRAFTED),
        ["fr"] = GetString(SI_ITEM_FORMAT_STR_CRAFTED),
        ["jp"] = GetString(SI_ITEM_FORMAT_STR_CRAFTED) or "細工された",
        ["ru"] = GetString(SI_ITEM_FORMAT_STR_CRAFTED) or "Создаваемый",
    },
    [LIBSETS_SETTYPE_CYRODIIL                        ] = {
    ...
    [LIBSETS_SETTYPE_DAILYRANDOMDUNGEONANDICREWARD  ] = {
        ...
        ["jp"] = (GetString(SI_DUNGEON_FINDER_RANDOM_FILTER_TEXT) .. " & " .. GetString(SI_CUSTOMERSERVICESUBMITFEEDBACKSUBCATEGORIES4) .. " " .. GetString(SI_LEVEL_UP_REWARDS_GAMEPAD_REWARD_SECTION_HEADER_SINGULAR))  or "ランダムな毎日のダンジョンと帝国都市の報酬",
    ...
    [LIBSETS_SETTYPE_DUNGEON                        ] = {
        ...
        ["ru"] = GetString(SI_INSTANCEDISPLAYTYPE2) or "Темница",
    },
    [LIBSETS_SETTYPE_IMPERIALCITY                        ] = {
        ...
        ["jp"] = GetString(SI_CUSTOMERSERVICESUBMITFEEDBACKSUBCATEGORIES4) or "帝国都市",
    ...
    [LIBSETS_SETTYPE_SPECIAL                        ] = {
        ...
        ["jp"] = GetString(SI_HOTBARCATEGORY9) or "特定",
    ...
    [LIBSETS_SETTYPE_TRIAL                        ] = {
        ...
        ["jp"] = GetString(SI_LFGACTIVITY4) or "試験",
